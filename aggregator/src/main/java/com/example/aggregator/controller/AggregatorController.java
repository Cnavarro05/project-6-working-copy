...
public class AggregatorController {
    ...
    public List<Entry> getAllPalindromes() {
        StopWatch sw = new StopWatch();
        sw.start();
        List<Entry> palindromes = service.getAllPalindromes(); // Call the new service method created in step 2
        sw.stop();

        long nanoSeconds = sw.getLastTaskTimeNanos();
        String message = new StringBuilder().append("Retrieved all palindromes, total count: ")
